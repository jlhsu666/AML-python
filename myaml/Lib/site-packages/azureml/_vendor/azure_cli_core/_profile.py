...
from azureml._vendor.azure_cli_core.adal_authentication import AdalAuthentication, BasicTokenCredential
                ...
                for s in external_tenants_info:
                    if user_type == _USER:
                        external_tokens.append(self._creds_cache.retrieve_token_for_user(
                            username_or_sp_id, s[_TENANT_ID], token_resource))
                    else:
                        external_tokens.append(self._creds_cache.retrieve_token_for_service_principal(
                            username_or_sp_id, resource, s[_TENANT_ID], token_resource))
