...
_ERROR_NO_AUTH_FILESHARE = 'Unable to authenticate fileshare datastore. If this is a credential-less datastore, this operation is not supported at the moment. If not, the account key or sas token is missing.'
