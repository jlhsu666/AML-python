...
class FileService(StorageClient):
    ...
    def __init__(self, account_name=None, account_key=None, sas_token=None,
        ...
        if self.account_key:
            self.__authentication = _StorageSharedKeyAuthentication(
                self.account_name,
                self.account_key,
            )
        elif self.sas_token:
            self.__authentication = _StorageSASAuthentication(self.sas_token)
    ...
    def authentication(self):
        if ((self.account_key is None or self.account_key is '') and (self.sas_token is None or self.sas_token is '')):
            raise ValueError(_ERROR_NO_AUTH_FILESHARE)
