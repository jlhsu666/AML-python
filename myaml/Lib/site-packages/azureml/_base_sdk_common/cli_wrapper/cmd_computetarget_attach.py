...
def attach_kubernetes(name, compute_resource_id, workspace_name=None, resource_group_name=None, aml_arc_config=None):
    import os
    import json
    workspace = get_workspace_or_default(workspace_name=workspace_name, resource_group=resource_group_name)
    ...
    instance_types = None
    if aml_arc_config and os.path.isfile(aml_arc_config):
        with open(aml_arc_config, 'r') as fp:
            aml_arc_config_dict = json.load(fp)
            if namespace in aml_arc_config_dict:
                namespace = aml_arc_config_dict['namespace']
            if default_instance_type in aml_arc_config_dict:
                default_instance_type = aml_arc_config_dict['default_instance_type']
            if instance_types in aml_arc_config_dict:
                instance_types = aml_arc_config_dict['instance_types']
